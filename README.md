...
[*] Время модификации файла: Sat Mar 14 15:30:00 2026 (Timestamp: 1773322200)
[*] Начинаю перебор сидов в диапазоне от 1773322080 до 1773322320...

Найден сид (timestamp): 1773322200
Определен формат: PDF Document
AES Ключ (hex): 5f4dcc3b5aa765d61d8327deb882cf99...
Расшифровываю весь файл...
Файл успешно расшифрован и сохранен как: DECRYPTED_document.pdf

## ⚙️ Как это работает
Скрипт воспроизводит логику сишного рантайма:
Подгружает msvcrt (Windows) или libc (Linux/macOS) через ctypes.
В цикле вызывает srand(seed) и генерирует последовательность rand(), идентичную той, что использовал шифровальщик.
Проверяет расшифрованный блок на соответствие магическим байтам (сигнатурам) популярных форматов.

## ⚠️ Disclaimer
Данный инструмент разработан исключительно для образовательных целей и помощи жертвам шифровальщиков в восстановлении данных. Автор не несет ответственности за любое использование данного кода в противоправных целях.

**Author:** @UnRezolved
**Channel:** t.me/ReChamo
